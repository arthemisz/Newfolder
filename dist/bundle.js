...
/* harmony export */   addChecklistItemToDOM: () => (/* binding */ addChecklistItemToDOM),
/* harmony export */   closeModal: () => (/* binding */ closeModal),
/* harmony export */   formatDate: () => (/* binding */ formatDate),
/* harmony export */   getFormChecklist: () => (/* binding */ getFormChecklist),
/* harmony export */   openModal: () => (/* binding */ openModal),
/* harmony export */   populateTodoForm: () => (/* binding */ populateTodoForm),
...
function formatDate(dateString) {
  ...
  var parsed = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateString);
  if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(parsed)) return dateString;
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(parsed, 'MMM dd, yyyy');
}

// Renders the project sidebar
function renderProjects(projects, currentProjectId, onSelectProject, onDeleteProject) {
  var list = document.getElementById('projectList');
  if (!list) return;
  list.innerHTML = '';
  projects.forEach(function (project) {
    var li = document.createElement('li');
    li.className = "project-item".concat(project.id === currentProjectId ? ' project-item--active' : '');
    li.innerHTML = "\n      <span class=\"project-item__name\">".concat(escapeHTML(project.name), "</span>\n      <span class=\"project-item__count\">").concat(project.todos.length, "</span>\n    ");
...
function renderTodos(project, onEditTodo, onDeleteTodo) {
  var container = document.getElementById('todoListContainer');
  var emptyState = document.getElementById('emptyState');
  var countElement = document.getElementById('todoCount');
  var titleElement = document.getElementById('currentProjectTitle');
  if (!container || !emptyState) return;
  titleElement.textContent = project.name;
  countElement.textContent = "".concat(project.todos.length, " task").concat(project.todos.length !== 1 ? 's' : '');
  container.innerHTML = '';
  ...
  var sorted = _toConsumableArray(project.todos).sort(function (a, b) {
  ...
  sorted.forEach(function (todo) {
    var card = createTodoCard(todo, onEditTodo, onDeleteTodo);
...
function createTodoCard(todo, onEditTodo, onDeleteTodo) {
  ...
  // Priority color bar
  var priorityClass = "todo-card--".concat(todo.priority);
  card.classList.add(priorityClass);
  var dueDateFormatted = todo.dueDate ? formatDate(todo.dueDate) : '';
  card.innerHTML = "\n    <div class=\"todo-card__header\">\n      <h3 class=\"todo-card__title\">".concat(escapeHTML(todo.title), "</h3>\n      <span class=\"todo-card__due ").concat(todo.dueDate ? '' : 'todo-card__due--none', "\">\n        ").concat(dueDateFormatted || 'No due date', "\n      </span>\n    </div>\n    ").concat(todo.description ? "<p class=\"todo-card__desc\">".concat(escapeHTML(todo.description), "</p>") : '', "\n    <div class=\"todo-card__footer\">\n      <span class=\"todo-card__priority-label\">\n        <span class=\"priority-dot priority-dot--").concat(todo.priority, "\"></span>\n        ").concat(todo.priority, "\n      </span>\n      <div class=\"todo-card__actions\">\n        <button class=\"btn--icon edit-todo-btn\" aria-label=\"Edit task\">\u270F\uFE0F</button>\n        <button class=\"btn--icon delete-todo-btn\" aria-label=\"Delete task\">\uD83D\uDDD1\uFE0F</button>\n      </div>\n    </div>\n  ");

  // Event listeners
  card.querySelector('.edit-todo-btn').addEventListener('click', function (e) {
    e.stopPropagation();
    onEditTodo(todo.id);
  });
  card.querySelector('.delete-todo-btn').addEventListener('click', function (e) {
    e.stopPropagation();
...
function addChecklistItemToDOM() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var index = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var container = document.getElementById('checklistContainer');
  var itemDiv = document.createElement('div');
  itemDiv.className = 'checklist-item';
  itemDiv.innerHTML = "\n    <input type=\"text\" class=\"form-input checklist-input\" placeholder=\"Checklist item\" value=\"".concat(escapeHTML(text), "\" maxlength=\"200\">\n    <button type=\"button\" class=\"btn--icon remove-checklist-btn\" aria-label=\"Remove item\">\u2715</button>\n  ");
  itemDiv.querySelector('.remove-checklist-btn').addEventListener('click', function () {
    itemDiv.remove();
  });
  if (index !== null) {
...
function getFormChecklist() {
  ...
  return Array.from(items).map(function (input) {
...
/* harmony export */ });
// src/js/storage.js
var STORAGE_KEY = 'taskflow_projects';
function saveProjects(projects) {
  try {
    var serialized = JSON.stringify(projects);
...
function createTodo() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    ...
    _ref$checklist = _ref.checklist,
    checklist = _ref$checklist === void 0 ? [] : _ref$checklist,
    _ref$id = _ref.id,
...
.priority-dot--high { background: var(--clr-high); }
.priority-dot--medium { background: var(--clr-medium); }
.priority-dot--low { background: var(--clr-low); }
...
.todo-card--high { border-left-color: var(--clr-high); }
.todo-card--medium { border-left-color: var(--clr-medium); }
.todo-card--low { border-left-color: var(--clr-low); }
...
.todo-card__due--none { font-style: italic; }
...
.form-error { display: none; color: var(--clr-danger); font-size: 0.8rem; }
...
.checklist-item .checklist-input { flex:1; }
...
}`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA,uCAAuC;AACvC;;;EAGE,sBAAsB;EACtB,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,iBAAiB;EACjB,sBAAsB;EACtB,sBAAsB;EACtB,sBAAsB;EACtB,qBAAqB;EACrB,qBAAqB;EACrB,mBAAmB;EACnB,yBAAyB;EACzB,qBAAqB;EACrB,mBAAmB;EACnB,qBAAqB;EACrB,kBAAkB;EAClB,wEAAwE;EACxE,aAAa;EACb,uBAAuB;AACzB;;AAEA;EACE,6DAA6D;EAC7D,yBAAyB;EACzB,sBAAsB;EACtB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,oBAAoB;AACtB;;AAEA;EACE,oBAAoB;AACtB;;AAEA,iCAAiC;AACjC;EACE,aAAa;EACb,iBAAiB;AACnB;;AAEA,kCAAkC;AAClC;EACE,YAAY;EACZ,8BAA8B;EAC9B,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,oBAAoB;EACpB,uCAAuC;EACvC,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,YAAY;EACZ,YAAY;EACZ,iBAAiB;EACjB,aAAa;AACf;;AAEA;EACE,iBAAiB;EACjB,yBAAyB;EACzB,mBAAmB;EACnB,cAAc;EACd,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,sBAAsB;EACtB,4BAA4B;EAC5B,eAAe;EACf,wCAAwC;EACxC,sBAAsB;AACxB;;AAEA;EACE,iCAAiC;AACnC;;AAEA;EACE,8BAA8B;EAC9B,gBAAgB;AAClB;;AAEA;EACE,OAAO;EACP,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;AACzB;;AAEA;EACE,iCAAiC;EACjC,mBAAmB;EACnB,sBAAsB;EACtB,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;EAChB,YAAY;EACZ,4BAA4B;EAC5B,iBAAiB;EACjB,UAAU;EACV,qCAAqC;EACrC,oBAAoB;AACtB;AACA;EACE,YAAY;AACd;AACA;EACE,wBAAwB;AAC1B;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,QAAQ;EACR,2BAA2B;EAC3B,WAAW;AACb;;AAEA,uCAAuC;AACvC;EACE,OAAO;EACP,uBAAuB;EACvB,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,qBAAqB;EACrB,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,4BAA4B;EAC5B,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,8BAA8B;EAC9B,mBAAmB;EACnB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,WAAW;EACX,iBAAiB;EACjB,4BAA4B;AAC9B;;AAEA;EACE,qBAAqB;EACrB,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,oBAAoB;AACtB;AACA,sBAAsB,2BAA2B,EAAE;AACnD,wBAAwB,6BAA6B,EAAE;AACvD,qBAAqB,0BAA0B,EAAE;;AAEjD,kCAAkC;AAClC;EACE,oBAAoB;EACpB,mBAAmB;EACnB,uBAAuB;EACvB,sBAAsB;EACtB,YAAY;EACZ,4BAA4B;EAC5B,gBAAgB;EAChB,kBAAkB;EAClB,WAAW;EACX,wDAAwD;AAC1D;AACA,aAAa,2BAA2B,EAAE;AAC1C,gBAAgB,8BAA8B,EAAE,YAAY,EAAE;AAC9D,eAAe,6BAA6B,EAAE,YAAY,EAAE;AAC5D,eAAe,6BAA6B,EAAE,YAAY,EAAE;AAC5D,kBAAkB,6BAA6B,EAAE,sBAAsB,EAAE;AACzE;EACE,uBAAuB;EACvB,mCAAmC;EACnC,sBAAsB;AACxB;AACA,cAAc,sBAAsB,EAAE,kBAAkB,EAAE;AAC1D,mBAAmB,WAAW,EAAE;AAChC;EACE,gBAAgB;EAChB,YAAY;EACZ,iBAAiB;EACjB,eAAe;EACf,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,oBAAoB;EACpB,mBAAmB;EACnB,uBAAuB;EACvB,wCAAwC;AAC1C;AACA,mBAAmB,2BAA2B,EAAE;;AAEhD,qCAAqC;AACrC;EACE,aAAa;EACb,4DAA4D;EAC5D,YAAY;AACd;;AAEA;EACE,8BAA8B;EAC9B,4BAA4B;EAC5B,gBAAgB;EAChB,yBAAyB;EACzB,kCAAkC;EAClC,eAAe;EACf,uCAAuC;AACzC;AACA,mBAAmB,2BAA2B,EAAE;AAChD,mBAAmB,kCAAkC,EAAE;AACvD,qBAAqB,oCAAoC,EAAE;AAC3D,kBAAkB,iCAAiC,EAAE;;AAErD;EACE,aAAa;EACb,8BAA8B;EAC9B,qBAAqB;EACrB,qBAAqB;AACvB;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;EACjB,4BAA4B;EAC5B,mBAAmB;AACrB;AACA,wBAAwB,kBAAkB,EAAE;;AAE5C;EACE,iBAAiB;EACjB,4BAA4B;EAC5B,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,WAAW;EACX,iBAAiB;EACjB,0BAA0B;AAC5B;;AAEA;EACE,aAAa;EACb,WAAW;AACb;;AAEA,iCAAiC;AACjC;EACE,aAAa;EACb,eAAe;EACf,QAAQ;EACR,YAAY;EACZ,mBAAmB;EACnB,uBAAuB;AACzB;AACA;EACE,aAAa;AACf;AACA;EACE,kBAAkB;EAClB,QAAQ;EACR,2BAA2B;AAC7B;AACA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,4BAA4B;EAC5B,aAAa;EACb,UAAU;EACV,gBAAgB;EAChB,gBAAgB;EAChB,gBAAgB;EAChB,4CAA4C;AAC9C;AACA,yBAAyB,gBAAgB,EAAE;AAC3C;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,qBAAqB;AACvB;AACA,gBAAgB,iBAAiB,EAAE;AACnC;EACE,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,cAAc;EACd,4BAA4B;AAC9B;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;AACA,cAAc,aAAa,EAAE,sBAAsB,EAAE,WAAW,EAAE;AAClE,YAAY,aAAa,EAAE,SAAS,EAAE;AACtC,oBAAoB,OAAO,EAAE;AAC7B,cAAc,gBAAgB,EAAE,iBAAiB,EAAE;AACnD,YAAY,wBAAwB,EAAE;AACtC;EACE,eAAe;EACf,mCAAmC;EACnC,4BAA4B;EAC5B,kBAAkB;EAClB,0CAA0C;AAC5C;AACA,oBAAoB,aAAa,EAAE,gCAAgC,EAAE;AACrE,iBAAiB,gBAAgB,EAAE;AACnC,eAAe,iBAAiB,EAAE;AAClC,cAAc,aAAa,EAAE,wBAAwB,EAAE,iBAAiB,EAAE;AAC1E,eAAe,+BAA+B,EAAE;AAChD,6BAA6B,cAAc,EAAE;;AAE7C;EACE,aAAa;EACb,sBAAsB;EACtB,WAAW;EACX,qBAAqB;AACvB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,WAAW;AACb;AACA,mCAAmC,MAAM,EAAE;AAC3C;EACE,gBAAgB;EAChB,YAAY;EACZ,wBAAwB;EACxB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,yBAAyB;EACzB,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,qBAAqB;EACrB,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,4BAA4B;EAC5B,aAAa;AACf;AACA,qBAAqB,eAAe,EAAE,mBAAmB,EAAE;;AAE3D,qCAAqC;AACrC;EACE;IACE,eAAe;IACf,OAAO;IACP,MAAM;IACN,SAAS;IACT,4BAA4B;IAC5B,YAAY;IACZ,YAAY;EACd;EACA;IACE,wBAAwB;EAC1B;EACA;IACE,cAAc;EAChB;EACA;IACE,cAAc;EAChB;EACA;IACE,oBAAoB;EACtB;EACA;IACE,0BAA0B;EAC5B;EACA;IACE,sBAAsB;EACxB;AACF","sourcesContent":["/* ========== RESET & BASE ========== */\n*,\n*::before,\n*::after {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\n:root {\n  --clr-bg: #030303;\n  --clr-surface: #ffffff;\n  --clr-sidebar: #1e2a38;\n  --clr-primary: #73f10d;\n  --clr-accent: #40e623;\n  --clr-danger: #ef4444;\n  --clr-text: #d6d9dd;\n  --clr-text-light: #06b3cd;\n  --clr-border: #e2e8f0;\n  --clr-high: #ef4444;\n  --clr-medium: #f59e0b;\n  --clr-low: #1bda9a;\n  --shadow: 0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -2px rgba(0,0,0,0.1);\n  --radius: 8px;\n  --transition: 0.2s ease;\n}\n\nbody {\n  font-family: 'Segoe UI', system-ui, -apple-system, sans-serif;\n  background: var(--clr-bg);\n  color: var(--clr-text);\n  line-height: 1.5;\n  min-height: 100vh;\n}\n\nbutton {\n  cursor: pointer;\n  font-family: inherit;\n}\n\ninput, select, textarea {\n  font-family: inherit;\n}\n\n/* ========== LAYOUT ========== */\n.app-container {\n  display: flex;\n  min-height: 100vh;\n}\n\n/* ---------- Sidebar ---------- */\n.sidebar {\n  width: 280px;\n  background: var(--clr-sidebar);\n  color: white;\n  display: flex;\n  flex-direction: column;\n  padding: 1.5rem 1rem;\n  transition: transform var(--transition);\n  position: relative;\n  z-index: 100;\n}\n\n.sidebar__header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 2rem;\n}\n\n.sidebar__logo {\n  font-size: 1.5rem;\n  font-weight: 700;\n  letter-spacing: -0.5px;\n}\n\n.sidebar__toggle {\n  background: none;\n  border: none;\n  color: white;\n  font-size: 1.5rem;\n  display: none;\n}\n\n.sidebar__section-title {\n  font-size: 0.8rem;\n  text-transform: uppercase;\n  letter-spacing: 1px;\n  color: #94a3b8;\n  margin-bottom: 0.75rem;\n}\n\n.project-list {\n  list-style: none;\n  margin-bottom: 2rem;\n}\n\n.project-item {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0.6rem 0.8rem;\n  border-radius: var(--radius);\n  cursor: pointer;\n  transition: background var(--transition);\n  margin-bottom: 0.25rem;\n}\n\n.project-item:hover {\n  background: rgba(255,255,255,0.1);\n}\n\n.project-item--active {\n  background: var(--clr-primary);\n  font-weight: 600;\n}\n\n.project-item__name {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.project-item__count {\n  background: rgba(255,255,255,0.2);\n  border-radius: 20px;\n  padding: 0.1rem 0.5rem;\n  font-size: 0.75rem;\n  margin: 0 0.25rem;\n}\n\n.project-item__delete {\n  background: none;\n  border: none;\n  color: rgba(255,255,255,0.6);\n  font-size: 0.9rem;\n  opacity: 0;\n  transition: opacity var(--transition);\n  margin-left: 0.25rem;\n}\n.project-item:hover .project-item__delete {\n  opacity: 0.8;\n}\n.project-item__delete:hover {\n  color: var(--clr-danger);\n}\n\n.sidebar__footer {\n  margin-top: auto;\n}\n\n.sidebar-overlay {\n  display: none;\n  position: fixed;\n  inset: 0;\n  background: rgba(0,0,0,0.4);\n  z-index: 90;\n}\n\n/* ---------- Main Content ---------- */\n.main-content {\n  flex: 1;\n  padding: 2rem 2rem 3rem;\n  overflow-y: auto;\n}\n\n.main-content__header {\n  display: flex;\n  align-items: baseline;\n  gap: 1rem;\n  margin-bottom: 2rem;\n}\n\n.main-content__title {\n  font-size: 2rem;\n  font-weight: 700;\n}\n\n.main-content__count {\n  color: var(--clr-text-light);\n  font-size: 0.95rem;\n}\n\n.main-content__toolbar {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 2rem;\n  gap: 1rem;\n}\n\n.filter-bar {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-size: 0.9rem;\n  color: var(--clr-text-light);\n}\n\n.priority-dot {\n  display: inline-block;\n  width: 12px;\n  height: 12px;\n  border-radius: 50%;\n  margin-right: 0.2rem;\n}\n.priority-dot--high { background: var(--clr-high); }\n.priority-dot--medium { background: var(--clr-medium); }\n.priority-dot--low { background: var(--clr-low); }\n\n/* ---------- Buttons ---------- */\n.btn {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  padding: 0.6rem 1.2rem;\n  border: none;\n  border-radius: var(--radius);\n  font-weight: 600;\n  font-size: 0.95rem;\n  gap: 0.4rem;\n  transition: background var(--transition), transform 0.1s;\n}\n.btn:hover { transform: translateY(-1px); }\n.btn--primary { background: var(--clr-primary); color: white; }\n.btn--accent { background: var(--clr-accent); color: white; }\n.btn--danger { background: var(--clr-danger); color: white; }\n.btn--secondary { background: var(--clr-border); color: var(--clr-text); }\n.btn--outline {\n  background: transparent;\n  border: 1px solid var(--clr-border);\n  color: var(--clr-text);\n}\n.btn--small { padding: 0.3rem 0.8rem; font-size: 0.85rem; }\n.btn--full-width { width: 100%; }\n.btn--icon {\n  background: none;\n  border: none;\n  font-size: 1.1rem;\n  padding: 0.2rem;\n  border-radius: 50%;\n  width: 30px;\n  height: 30px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  transition: background var(--transition);\n}\n.btn--icon:hover { background: rgba(0,0,0,0.1); }\n\n/* ---------- Todo Cards ---------- */\n.todo-list-container {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\n  gap: 1.25rem;\n}\n\n.todo-card {\n  background: var(--clr-surface);\n  border-radius: var(--radius);\n  padding: 1.25rem;\n  box-shadow: var(--shadow);\n  border-left: 4px solid transparent;\n  cursor: pointer;\n  transition: transform var(--transition);\n}\n.todo-card:hover { transform: translateY(-3px); }\n.todo-card--high { border-left-color: var(--clr-high); }\n.todo-card--medium { border-left-color: var(--clr-medium); }\n.todo-card--low { border-left-color: var(--clr-low); }\n\n.todo-card__header {\n  display: flex;\n  justify-content: space-between;\n  align-items: baseline;\n  margin-bottom: 0.5rem;\n}\n\n.todo-card__title {\n  font-size: 1.1rem;\n  font-weight: 600;\n}\n\n.todo-card__due {\n  font-size: 0.8rem;\n  color: var(--clr-text-light);\n  white-space: nowrap;\n}\n.todo-card__due--none { font-style: italic; }\n\n.todo-card__desc {\n  font-size: 0.9rem;\n  color: var(--clr-text-light);\n  margin-bottom: 1rem;\n}\n\n.todo-card__footer {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n\n.todo-card__priority-label {\n  display: flex;\n  align-items: center;\n  gap: 0.3rem;\n  font-size: 0.8rem;\n  text-transform: capitalize;\n}\n\n.todo-card__actions {\n  display: flex;\n  gap: 0.2rem;\n}\n\n/* ---------- Modals ---------- */\n.modal {\n  display: none;\n  position: fixed;\n  inset: 0;\n  z-index: 200;\n  align-items: center;\n  justify-content: center;\n}\n.modal--open {\n  display: flex;\n}\n.modal__backdrop {\n  position: absolute;\n  inset: 0;\n  background: rgba(0,0,0,0.5);\n}\n.modal__content {\n  position: relative;\n  background: white;\n  border-radius: var(--radius);\n  padding: 2rem;\n  width: 90%;\n  max-width: 600px;\n  max-height: 85vh;\n  overflow-y: auto;\n  box-shadow: 0 20px 25px -5px rgba(0,0,0,0.2);\n}\n.modal__content--small { max-width: 400px; }\n.modal__header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1.5rem;\n}\n.modal__title { font-size: 1.4rem; }\n.modal__close {\n  background: none;\n  border: none;\n  font-size: 2rem;\n  line-height: 1;\n  color: var(--clr-text-light);\n}\n.modal__form {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.form-group { display: flex; flex-direction: column; gap: 0.3rem; }\n.form-row { display: flex; gap: 1rem; }\n.form-group--half { flex: 1; }\n.form-label { font-weight: 600; font-size: 0.9rem; }\n.required { color: var(--clr-danger); }\n.form-input {\n  padding: 0.6rem;\n  border: 1px solid var(--clr-border);\n  border-radius: var(--radius);\n  font-size: 0.95rem;\n  transition: border-color var(--transition);\n}\n.form-input:focus { outline: none; border-color: var(--clr-primary); }\n.form-textarea { resize: vertical; }\n.form-select { background: white; }\n.form-error { display: none; color: var(--clr-danger); font-size: 0.8rem; }\n.input-error { border-color: var(--clr-danger); }\n.input-error + .form-error { display: block; }\n\n.checklist-editor {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n  margin-bottom: 0.5rem;\n}\n.checklist-item {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.checklist-item .checklist-input { flex:1; }\n.remove-checklist-btn {\n  background: none;\n  border: none;\n  color: var(--clr-danger);\n  font-size: 1.2rem;\n}\n\n.modal__actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.75rem;\n  margin-top: 1rem;\n}\n\n.confirm-message {\n  margin: 1rem 0 1.5rem;\n  color: var(--clr-text-light);\n}\n\n.empty-state {\n  text-align: center;\n  padding: 3rem 1rem;\n  color: var(--clr-text-light);\n  display: none;\n}\n.empty-state__icon { font-size: 3rem; margin-bottom: 1rem; }\n\n/* ========== RESPONSIVE ========== */\n@media (max-width: 768px) {\n  .sidebar {\n    position: fixed;\n    left: 0;\n    top: 0;\n    bottom: 0;\n    transform: translateX(-100%);\n    width: 260px;\n    z-index: 100;\n  }\n  .sidebar--open {\n    transform: translateX(0);\n  }\n  .sidebar__toggle {\n    display: block;\n  }\n  .sidebar-overlay--visible {\n    display: block;\n  }\n  .main-content {\n    padding: 1.5rem 1rem;\n  }\n  .todo-list-container {\n    grid-template-columns: 1fr;\n  }\n  .form-row {\n    flex-direction: column;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
var pendingDeleteCallback = null; // for confirm modal

// ========== INITIALIZATION ==========
function initializeApp() {
  // Load from localStorage or seed default project
  var stored = (0,_storage__WEBPACK_IMPORTED_MODULE_3__.loadProjects)();
  if (stored && stored.length > 0) {
    projects = stored;
  } else {
    // Create default project
    var defaultProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__["default"])('My Tasks');
    projects.push(defaultProject);
    (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProjects)(projects);
  }
...
function renderAll() {
  ...
  (0,_dom__WEBPACK_IMPORTED_MODULE_4__.renderProjects)(projects, currentProjectId, selectProject, handleDeleteProject);
  if (currentProject) {
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.renderTodos)(currentProject, handleEditTodo, handleDeleteTodo);
  }
}
...
function attachGlobalListeners() {
  ...
  document.getElementById('addProjectBtn').addEventListener('click', function () {
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.openModal)('projectModal');
  ...
  document.getElementById('addTodoBtn').addEventListener('click', function () {
    ...
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.resetTodoForm)();
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.openModal)('todoModal');
  });

  // Close modals (cancel buttons, close icons)
  document.getElementById('closeTodoModalBtn').addEventListener('click', function () {
    return (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('todoModal');
  });
  document.getElementById('cancelTodoBtn').addEventListener('click', function () {
    return (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('todoModal');
  });
  document.getElementById('closeProjectModalBtn').addEventListener('click', function () {
    return (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('projectModal');
  });
  ...
  document.getElementById('closeConfirmModalBtn').addEventListener('click', function () {
    return (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('confirmModal');
  });
  ...
  document.querySelectorAll('.modal__backdrop').forEach(function (backdrop) {
    backdrop.addEventListener('click', function () {
      ...
      if (modal) (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)(modal.id);
    });
  });
  ...
  document.getElementById('projectForm').addEventListener('submit', function (e) {
    ...
    var newProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__["default"])(name);
    projects.push(newProject);
    currentProjectId = newProject.id;
    (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProjects)(projects);
    renderAll();
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('projectModal');
  ...
  document.getElementById('todoForm').addEventListener('submit', function (e) {
    ...
    var notes = document.getElementById('todoNotes').value.trim();
    var checklist = (0,_dom__WEBPACK_IMPORTED_MODULE_4__.getFormChecklist)();
    var currentProject = getCurrentProject();
    if (!currentProject) return;
    if (todoId) {
      // Editing existing todo
      var existing = currentProject.getTodo(Number(todoId));
      if (existing) {
      ...
      // New todo
      var newTodo = (0,_todo__WEBPACK_IMPORTED_MODULE_2__["default"])({
        title: title,
        description: description,
        dueDate: dueDate,
        priority: priority,
    ...
    (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProjects)(projects);
    renderAll();
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('todoModal');
    titleInput.classList.remove('input-error');
  });

  // Add checklist item button
  document.getElementById('addChecklistItemBtn').addEventListener('click', function () {
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.addChecklistItemToDOM)();
  });
  ...
  document.getElementById('confirmDeleteBtn').addEventListener('click', function () {
    ...
    (0,_dom__WEBPACK_IMPORTED_MODULE_4__.closeModal)('confirmModal');
  });
}
...
function handleEditTodo(todoId) {
  ...
  if (!project) return;
  var todo = project.getTodo(todoId);
  if (!todo) return;
  (0,_dom__WEBPACK_IMPORTED_MODULE_4__.populateTodoForm)(todo);
  (0,_dom__WEBPACK_IMPORTED_MODULE_4__.openModal)('todoModal');
}
function handleDeleteTodo(todoId) {
  ...
  var todo = project.getTodo(todoId);
  if (!todo) return;
  document.getElementById('confirmMessage').textContent = "Delete task \"".concat(todo.title, "\"?");
  pendingDeleteCallback = function pendingDeleteCallback() {
    project.removeTodo(todoId);
    (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProjects)(projects);
    renderAll();
  };
  (0,_dom__WEBPACK_IMPORTED_MODULE_4__.openModal)('confirmModal');
}
function handleDeleteProject(projectId) {
  ...
  var projectToDelete = projects.find(function (p) {
    return p.id === projectId;
  });
  if (!projectToDelete) return;
  document.getElementById('confirmMessage').textContent = "Delete project \"".concat(projectToDelete.name, "\" and all its tasks?");
  pendingDeleteCallback = function pendingDeleteCallback() {
